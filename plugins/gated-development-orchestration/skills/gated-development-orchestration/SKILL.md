...
Governance Triage loads the workflow core first and classifies the BLOCKED return; it is not a sixth round and cannot PASS. GDO 4.2 preserves non-dispatch Human TAKEOVER and adds bounded correction/evidence-economy rules; load the core for these semantics and never treat takeover or implementation behavior as a contract amendment.
