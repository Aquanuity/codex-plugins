...
Governance Triage loads the workflow core first and classifies the BLOCKED return; it is not a sixth round and cannot PASS. GDO 4.3 preserves Human TAKEOVER and GDO 4.2 correction/evidence economy, and adds delta-oriented lifecycle-comment discipline; load the core for these semantics and never treat takeover or implementation behavior as a contract amendment.
